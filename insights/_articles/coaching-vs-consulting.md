...
title: "Coaching vs. Consulting: What's the Difference and Which One Do You Need?"
...
Coaching develops the leader's capacity to solve future problems. Consulting solves the current one. Coaching is client-directed: the advisor Helps you think more clearly. Consulting is expert-directed: the advisor gives you the answer. Both are legitimate; the question is which one your situation actually requires.

### Can an executive coach also do consulting?

Yes. Effective practitioners move between modes depending on what the situation calls for. The failure is not doing both. It is doing one when the other is what's needed, or not being clear about which mode you're in.

### What happens when a leader wants consulting but needs coaching?

The engagement produces a plan the team doesn't own and doesn't sustain. They follow it for a few months and then revert, because nothing in the underlying system changed. The recommendation was right; the mechanism of change was wrong.

### When does coaching not work?

When the problem is structural rather than behavioral. If role design is creating the conflict, or if the business model has a flaw, no amount of leadership development will fix it. A good coach names this rather than coaching around it.

### How do I know if I need a coach or a consultant?

Ask what you want to be different in a year. If the answer is about the business, specifically better strategy, cleaner operations, clearer structure, you probably want consulting. If the answer is about the people and how they work together, you probably want coaching. Most leadership team problems sit in the second category.

### Why do leadership engagements fail?

The most common reason is a mismatch between what the client expects to receive and what the situation actually requires. A client who wants to be handed a roadmap and gets a coaching process will be frustrated. A client who needs to build internal capacity and gets a consulting deck will revert to old patterns within eighteen months.
