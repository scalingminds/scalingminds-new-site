---
slug: cost-of-executive-team-dysfunction
title: "What Executive Team Dysfunction Actually Costs"
...
### How do I calculate the cost of dysfunction for my own team?

Four inputs, one afternoon. One: your last ten significant decisions, with the calendar gap between "raised" and "actually settled." Two: decisions from the past year that got re-decided. Three: executive departures in 24 months, priced at one to two times comp each. Four: strategic initiatives that stalled or died, priced at what they were supposed to produce. The total is conservative, because it skips the compounding, and it'll still be bigger than you guessed.

### Is slow decision-making always a dysfunction problem?

No. Some decisions deserve to be slow, big capital commitments, irreversible bets, and a deliberate team is different from a stuck one. The test is what fills the time. Deliberation means new information is arriving and changing the analysis. Dysfunction means the same conversation is repeating with the truth edited out. If the third meeting on a topic sounds like the first one, you're not deliberating.

### Does this cost show up differently in PE-backed companies?

Same costs, compressed timeline, so everything weighs more. A hold period turns time into the scarcest asset on the balance sheet, and inherited leadership teams, the normal PE situation, carry pre-existing dysfunction the new CEO didn't create but absolutely owns. The other difference is visibility: a board sees execution velocity clearly and team dynamics not at all, so the dysfunction gets misdiagnosed as an operations problem and treated with the wrong tools.

### What's the cheapest way to start fixing it?

Measurement, which costs nothing and changes the conversation. Put the number in front of your team and ask them what's driving it. The meeting where an executive team prices its own dysfunction out loud is uncomfortable and clarifying in roughly equal measure, and it converts the topic from a soft people issue into what it actually is: the most expensive operational problem in the company.
