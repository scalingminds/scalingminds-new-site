---
slug: everything-runs-through-me
title: "Why Everything in My Company Runs Through Me"
...
### Is this the same as the founder bottleneck?

Same pattern, two halves. The founder bottleneck article looks at it structurally: how companies grow up around one person's judgment and what rebuilds the decision system. This is the lived half, what the pattern looks like from inside your calendar, and the part of it you personally maintain. Most CEOs need both, because structure built around an unchanged habit collapses back inside a quarter.

### What if things genuinely do go wrong when I'm not involved?

Some will, especially early, and the math still works. Count what your involvement costs: every decision that waits for you ages, your best people stall, and your own judgment gets spent on volume instead of the calls that need it. A team learning to decide will run maybe an 80 percent hit rate at first against your 90. The 80 compounds upward. Your 90 is already the ceiling, and you're the only one who can't scale.

### Should I just block off focus time and protect my calendar?

Calendar defense treats the symptom and loses to it. Block the morning and the queue waits politely until afternoon, because the routing is still pointed at you. Time management assumes the demand is fixed. The actual fix is shrinking the demand, fewer things needing you at all, which is team-building work, with calendar relief arriving as the byproduct.

### How long before the 8pm questions stop?

The volume drops fast, within weeks, once you stop answering reflexively and start routing questions back. The deeper change, a team that genuinely runs its part of the company, is a year-plus of work. One honest warning: the early quiet feels wrong. CEOs report checking their phone at 9pm and feeling something between relief and uselessness. That feeling is withdrawal, it's normal, and it passes into something much better.
