---
slug: leaders-wont-take-ownership
title: "My Leaders Won't Take Ownership: Why Everything Escalates to You"
...
A services company I worked with had a CEO drowning in exactly this. We counted: 23 decisions escalated to his desk in two weeks, most of them well within his executives' pay grades. The root turned out to be a moment two years old. A VP had owned a botched systems migration and gotten publicly carved up for it in a leadership meeting. Everyone watched. Everyone adjusted.

So the work didn't start with accountability. It started with the CEO changing what a miss costs, beginning with a meeting where he reopened that migration story and owned his part in how it was handled. Months of that built enough trust that the team started telling the truth about targets and timelines before committing to them. Only then did ownership hold, because for the first time people were committing to things they actually believed. Trust, then candor, then ownership. That sequence is the spine of [the Six Shifts](/six-shifts), and teams who grab for ownership first end up right back in the escalation line, just with better vocabulary. By the end of that year, the CEO's count was down to a handful of escalations a month, and the ones that reached him were the ones that should.
...
### Do I have the wrong people, or the wrong system?

Probably the system, and there's an honest way to find out. Change what mistakes cost and watch who steps up over the next two quarters. In my experience most of the team grows fast once the conditions change, and one or two people keep escalating anyway, because they genuinely prefer a job without exposure. Then you have a personnel decision, made with real information instead of a guess.

### Should I just refuse to decide and let things fail?

The sink-or-swim move usually backfires. Refusing to engage while the old fear is still in place doesn't teach ownership. It teaches your team that you've added a guessing game to the danger. The order matters: make honesty and misses survivable first, then hand back the decisions. Done backwards, you get quiet chaos and a few expensive failures that confirm everyone's caution.

### What's the difference between accountability and ownership?

Accountability is answering for an outcome after the fact. Ownership is the thing that happens before: shaping the goal, believing the plan, making the calls along the way. You can hold people accountable all day for outcomes they never owned, and what you'll harvest is excuses, most of them pretty good ones. Ownership has to be built upstream, where the commitments get made.

### How long until the escalations actually stop?

You'll see the count drop within a quarter if you change how misses get handled and stay consistent. The deeper shift, where leaders bring you problems already half-solved and decisions already made, takes a year or so. One relapse from you, one carved-up VP in one meeting, resets a surprising amount of the clock. Consistency is most of the game.
