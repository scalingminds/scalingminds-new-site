---
slug: nonprofit-leadership-team-coaching
title: "Executive Coaching for Nonprofit Leadership Teams"
...
### How is coaching a nonprofit leadership team different from coaching a corporate one?

The mechanics are the same and the texture is different. Nonprofit teams usually start with more genuine care between people and more avoidance built on top of it, so the trust work goes faster and the candor work goes slower. Board dynamics add a layer corporate teams don't carry. And the motivation question never needs asking, which is its own gift: nobody has to be convinced the work matters, only that it's safe.

### How do I justify the expense to my board?

With specifics instead of leadership language. Name what the current patterns are costing in mission terms: the program decisions that took six months, the director you lost, the grant window that closed. Boards fund capacity problems they can see. The framing that works is about what the organization will be able to deliver, because that's what's actually true, and most boards have watched the team struggle for longer than the ED realizes.

### Our team genuinely likes each other. Can the problem really be trust?

Affection and trust are different things, and mission organizations have lots of the first. The trust that teams run on is narrower: certainty that you can disagree with me, in the meeting, and our relationship survives it. Teams that love each other often have less of that, because the relationships feel too precious to risk. The good news is the affection is real raw material. Teams that care build faster, once they stop using the caring as a reason to stay quiet.

### Does the executive director have to be part of it?

Yes, fully, sessions and feedback and all of it. Every pattern on a senior team organizes around its most powerful person, and at nonprofits that effect is amplified, because EDs are often founders in spirit if not in title, and staff devotion to the leader can make honest disagreement feel like disloyalty. An ED willing to hear the truth about their own patterns, in front of the team, moves the whole organization. I've watched it happen in a single meeting.
