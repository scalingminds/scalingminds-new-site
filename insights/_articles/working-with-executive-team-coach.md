---
slug: working-with-executive-team-coach
title: "What Working With an Executive Team Coach Actually Looks Like"
...
### How long does an executive team coaching engagement last?

A year is the honest unit, sometimes longer for deeper rebuilds. Behavior on a team is habit, and habits hold their shape for months after everyone agrees they should change. Shorter engagements exist, a focused six months can reset how a team talks, but anyone promising transformation in a quarter is selling you the offsite you've already tried.

### Is it all meetings, or is there an offsite?

Usually both, with the weight on the regular meetings. Offsites are good for the diagnostic readout and for sessions that need room to breathe. The reason in-meeting work carries the engagement is transfer: teams behave beautifully in the mountains and revert at the Tuesday standup, so the Tuesday standup is where the new behavior has to be installed.

### What if one executive refuses to engage?

It happens, and it's information. A good coach works with resistance for a while, because resistance is often a trust question in disguise and it softens as the room gets safer. Sometimes it doesn't soften, and the team ends up facing a question that predated the coach: whether someone who won't do what the team does belongs on the team. The coaching didn't create that question. It just stopped everyone pretending it wasn't there.

### Does the coach report to the CEO or to the team?

The team, and this matters more than it sounds. If the coach is functionally the CEO's agent, the room knows within a session and the candor dies. The CEO is the buyer, but the client is the team as a unit, including how the team experiences the CEO. Ask any coach you're vetting how they handle hearing something about the CEO in a confidential interview. The quality of that answer tells you a lot.
